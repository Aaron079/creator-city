      ...
      <div className="create-setup-shell">
        <div className="flex flex-wrap items-start justify-between gap-4">
          <div>
            ...
            <h2 className="mt-2 text-2xl font-light tracking-[-0.03em] text-white">这项目建议先这样起步</h2>
        ...
        <div className="mt-5 grid gap-4 xl:grid-cols-[1.1fr_0.9fr]">
          ...
          <div className="space-y-4">
            ...
            <div className="rounded-[28px] border border-amber-500/18 bg-amber-500/8 p-4 backdrop-blur-2xl">
