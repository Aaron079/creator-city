...
export default async function CreateV2Page({ searchParams }: PageProps) {
  ...
  return (
    <div style={{ width: '100vw', height: '100vh', display: 'flex', flexDirection: 'column', background: '#080814', overflow: 'hidden' }}>
      <header style={{ height: 52, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: '0 20px', background: 'rgba(8,8,20,0.98)', borderBottom: '1px solid rgba(124,58,237,0.2)', flexShrink: 0, zIndex: 100 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 14 }}>
          ...
          {projectId && <span style={{ fontSize: 11, color: '#4b5563' }}>项目: {projectId.slice(0, 8)}…</span>}
        </div>
