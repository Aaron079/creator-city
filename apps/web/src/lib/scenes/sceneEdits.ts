...
export const SCENE_EDIT_TOOL_OPTIONS: SceneEditToolOption[] = [
  {
    ...
    label: '天气',
    icon: '☔',
    instruction: '调整该区域的天气效果，例如雨、雾、雪、黄昏湿度。',
    cursor: 'crosshair',
  },
  {
    tool: 'color',
    label: '调色',
    icon: '🎨',
    instruction: '调整该区域的色调、饱和度、冷暖和对比度。',
    cursor: 'cell',
  },
  {
    tool: 'lighting',
    label: '光线',
    icon: '💡',
    instruction: '调整该区域光源方向、亮度、高光和阴影。',
    cursor: 'crosshair',
  },
  {
    tool: 'atmosphere',
    label: '氛围',
    icon: '🌫',
    instruction: '增强该区域的氛围，例如雾气、孤独感、压迫感、电影感。',
    cursor: 'crosshair',
  },
  {
    tool: 'person',
    label: '人物',
    icon: '👤',
    instruction: '在该区域增加或强化人物存在，但保持整体风格一致。',
    cursor: 'copy',
  },
  {
    tool: 'architecture',
    label: '建筑',
    icon: '🏙',
    instruction: '调整建筑密度、空间结构、玻璃幕墙、城市纵深。',
    cursor: 'crosshair',
  },
  {
    tool: 'prop',
