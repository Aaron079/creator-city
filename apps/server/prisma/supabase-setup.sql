-- ============================================================
-- Creator City — Full schema setup for Supabase SQL Editor
-- Run this in: Supabase Dashboard → SQL Editor → New query
-- This is safe to run on an EMPTY database only.
-- ============================================================
...
VALUES (
    ...
    '3b81735f8703acdc0977adc5538d4d3c0658f31e4f7d0ec4cb3c20afc5d63057',
    now(),
    '20260501072452_add_credits_billing',
    NULL,
    NULL,
    now(),
    1
