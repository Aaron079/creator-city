...
Last valid commit: Web3 Foundation P0-4 IMPLEMENTED — AssetListing schema-lite（migration add_asset_listing，listing lifecycle draft/active/paused/archived，/marketplace 读 ACTIVE listing，不做购买不接 billing）
