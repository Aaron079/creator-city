...
| Canvas Smart Tools — Generate Readiness Check（右侧工具栏 · 生成前体检） | 🚧 IMPLEMENTED / browser validation pending | `fa62030` |
