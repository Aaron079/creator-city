...
Last valid commit: Web3 Foundation P0-3 IMPLEMENTED — Marketplace 真实化（metadata-only marketplaceIntent，/marketplace 真实资产，/assets/[id] 发布意向编辑器）
