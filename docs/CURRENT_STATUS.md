...
Last updated: 2026-06-16 (P2-TOOL-UX-2+3 DONE — CameraLexicon 34 icons; CharacterBible + SceneBible visual tag chips for 6 fields; appendToField helper; bible→prompt injection intact; type-check PASS · lint PASS · build PASS)
