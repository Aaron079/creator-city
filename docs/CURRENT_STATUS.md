...
Last valid commit: Web3 Foundation P0-1B — metadata-only asset license intent
...
| Web3 Foundation P0-1B — 资产授权意图 metadata-only | ✅ IMPLEMENTED / Asset.metadataJson.licenseIntent · 4 可用 mode · marketplace_license disabled · /assets/[id] owner 编辑器 · /me license badge · 不改 schema · 不做交易 | pending commit |
