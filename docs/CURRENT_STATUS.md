...
| BYOK Observation Playbook（30–60 天观察期运营 Playbook） | ✅ IMPLEMENTED / browser validation pending | — |
...
| BYOK Observation Playbook（30–60 天观察期运营 Playbook） | ✅ implemented（/admin/usage indigo 区块；4 组静态文案：每周固定查看 / 继续观察 / 先修稳定性 / 可进入下一阶段；6 条 no-go；纯静态不写 DB 不扣费不改 schema）|
