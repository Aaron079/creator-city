...
Last valid commit: Web3 Foundation P0-9 IMPLEMENTED — MarketplaceOrder QUOTED state（migration 20260612000001_add_marketplace_order_quoted，QUOTED enum value + quotedAt column，PATCH action:quote seller PENDING→QUOTED，seller 确认报价意向按钮，seller 拒绝按钮，/marketplace buyer 报价确认蓝色 badge + 免责声明，/assets/[id] buyer QUOTED 状态展示，不扣款不创建 LicenseGrant 不接 wallet）
