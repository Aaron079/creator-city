...
Last valid commit: Web3 Foundation P0-5 IMPLEMENTED — Free-only LicenseGrant（migration add_license_grant，priceCredits=0 免费授权领取，/marketplace 免费领取按钮，/assets/[id] 卖家授权计数 + 买家授权 badge，/api/me/licenses，不做购买不接 billing 不新增 MarketplaceOrder）
